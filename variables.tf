variable "app_name" {
  ...
  type = "string"
  default = "autobillingtestapp-d-1521"
}

variable "custom_domain" {
  description = "Custom domain name (optional)"
  type = "string"
  default = "autobillingtestapp-d-1521.botics.co"
}
...
variable "repo_url" {
    ...
    type = "string"
    default = "https://github.com/crowdbotics-apps/autobillingtestapp-d-1521/archive/master.tar.gz"
}
